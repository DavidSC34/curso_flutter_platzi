  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Review("assets/imgs/people.jpg", "Mario Perez", "1 review 5 photos", "Hermoso lugar para visitar "),
        Review("assets/imgs/people.jpg", "Marible Sanchez", "2 review 6 photos", "No hay potro lugar mas divertido que este")
      ],
    );
  }
